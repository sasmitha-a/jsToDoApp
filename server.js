...
async function go() {
    let client = new MongoClient('mongodb+srv://sas123:sasmi123@cluster0.mnidaec.mongodb.net/ToDoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next) {
    ...
    if (req.headers.authorization == 'Basic c2FzOnNhc21p') {
        next()
    } else {
